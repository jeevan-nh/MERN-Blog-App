...
const SECRET = process.env.SECRET || 'asfqwrszvsgsgwheqwoapasdkajbfuegbesdjasfbeaiug'
                ...
                bcrypt.genSalt(10,(err,salt) => {
                    bcrypt.hash(newUser.password,salt,(err,hash) => {
                        ...
                        newUser.save()
                            ...
                            .catch(err => console.log({error: "error creating new user:"+err}));
                    });
                });
            }
        });
            ...
            bcrypt.compare(password,user.password)
                .then(isMatch => {
                    if(isMatch){
                        ...
                        jwt.sign(paylod,SECRET,{expiresIn:3600},(err,token) => {
                            if(err) {
                                console.log(err)
                            }
                            return res.json({
